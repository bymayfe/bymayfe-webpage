      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 dark:text-white text-black md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            ...
            <p className="text-3xl md:text-3xl max-sm:text-xl mt-3 bg-clip-text text-transparent bg-gradient-to-r from-[#00040f] to-slate-500 dark:from-slate-500 dark:to-slate-200 max-w-[80%] md:max-w-[490px] text-left">
              I am a{" "}
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              role="button"
              target="_blank"
              href={personalData.spotifyStats}
            >
              <span>Spotify Project</span>
              <FaSpotify size={16} />
            </Link>
          </div>
        </div>
